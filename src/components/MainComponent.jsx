  ...
  return (
    <section className='mb-12'>
        <picture>
            ...
            <img src={imgMobile} alt="principal acticle image" />
        </picture>
        <div className='sm:flex'>
            ...
            <div className='flex-1 pt-9'>
                <p className='text-[13px] mb-[10px] sm:text-[15px]'>We dive into the next evolution of the web that claims to put the power of the platforms back into the hands of the people. 
